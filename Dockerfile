...
USER 10000:10000
EXPOSE 3000
ENTRYPOINT ["node", "scripts/load-secret-env.mjs", "BETTER_AUTH_SECRET", "SIGIL_AGENT_BINDING_SECRET", "--"]
...
WORKDIR /app
EXPOSE 3001
ENTRYPOINT ["node", "scripts/load-secret-env.mjs", "SIGIL_AGENT_BINDING_SECRET", "--"]
