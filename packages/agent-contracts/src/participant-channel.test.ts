  ...
  const channel = {
    ...
    participants: [
      ...
      },
      {
        ...
        runtimeSessionId: "eve-session-coordinator-a",
      ...
      },
      {
        ...
        runtimeSessionId: "eve-session-dormant-a",
  ...
  it("accepts a dispatch receipt naming coordinator, target, and bounds", () => {
    const receipt = {
      ...
      intended: {
        ...
        targetRuntimeSessionId: "eve-session-a",
    ...
    expect(
      isAgentParticipantDispatchReceipt({
        ...
        intended: {
          channelId: "channel-a",
          targetParticipantId: "participant-eve-a",
          targetRuntimeSessionId: "eve-session-other",
          targetApplicationThreadId: "thread-a",
        },
        bounds: {
          requestedAt: 100,
      ...
      isAgentParticipantDispatchReceiptForChannel(
        {
          ...
          intended: {
            ...
            targetRuntimeSessionId: "eve-session-dormant-a",
